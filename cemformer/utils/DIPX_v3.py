...
class CustomDataset(Dataset):
    def __init__(self,csv_type, debug=None, transform=None):
        ...
        self.face_path = '/scratch/mukil/dipx/common/aria_common'
        self.gaze_path = '/scratch/mukil/dipx/common/gaze_common'
    ...
    def _load_data(self):
        with open(self.csv_path, 'r') as csv_file:
            ...
            for row in reader:
                ...
                gaze_path = os.path.join(self.gaze_path, name)
                ...
                if os.path.exists(road_path):
                    ...
                    self.data.append(( road_path,gaze_path,face_path, target, gaze, ego))
    ...
    def __getitem__(self, idx):
        while True:
            road_path,gaze_path, face_path, target, gaze, ego = self.data[idx]
            ...
            fl1,fl2,fl3= False,False,False
            video_frames1,fl1 = decode_video(road_path, start, end)
            video_frames2,fl2 = decode_video(face_path, start, end)
            video_frames3,fl3 = decode_video(gaze_path, start, end)

            if fl1==True or fl2==True or fl3==True: 
            ...
            if random.random() < -1:  
                ...
                video_frames1,video_frames2,video_frames3 = video_to_tensor(video_frames1.copy()),video_to_tensor(video_frames2.copy()),video_to_tensor(video_frames3.copy())
            else:
                video_frames1,video_frames2,video_frames3 = video_to_tensor(video_frames1),video_to_tensor(video_frames2),video_to_tensor(video_frames3)
            ...
            if self.transform:
                ...
                video_frames3 = video_frames3.permute(1,0,2,3)
            ...
            video_frames3 = torch.nn.functional.interpolate(video_frames3, size=(224, 224), mode='bilinear')   

            return video_frames1,video_frames2,video_frames3, target, gaze, ego 
