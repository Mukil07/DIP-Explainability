...
OMP_NUM_THREADS=1
python main_test.py --model i3d --batch 1  
# python main_test.py --model memvit --mem_per_layer 4
# python main_test.py --model memvit --mem_per_layer 6 
# python main_test.py --model memvit --mem_per_layer 8
# python main_test.py --model memvit --mem_per_layer 10 
