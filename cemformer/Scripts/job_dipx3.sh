...
#SBATCH --output=output_DIPX/CEM_DIPX02.txt
...
torchrun --nproc_per_node=1 --master_addr localhost --master_port 15476 main_dipx.py --model memvit_dipx --num_classes 7 --mem_per_layer 4 --batch 1 
