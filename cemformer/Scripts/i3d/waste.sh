...
python i3d/i3d_final.py --model $MODEL --batch 2 --num_classes 7 --dataset $DATASET --technique $TECH \
    --n_attributes 17 --multitask_classes 15  -ego_cbm -multitask -bottleneck --debug debug 
