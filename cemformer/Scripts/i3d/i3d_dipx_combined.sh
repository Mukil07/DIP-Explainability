...
#SBATCH --output=output_DIPX/i3d_combined_new.txt
...
#     --n_attributes 32 --dropout 0.45 -combined_bottleneck -bottleneck 

python i3d/i3d_final.py --model $MODEL --batch 1 --num_classes 7 --dataset $DATASET \
    --technique $TECH --n_attributes 32 --dropout 0.45 -combined_bottleneck -bottleneck


#lstm 
MODEL=i3d_lstm
python i3d/i3d_final.py --model $MODEL --batch 1 --num_classes 7 --expand_dim 512 \
