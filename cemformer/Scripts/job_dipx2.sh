...
#SBATCH --output=output_DIPX/CEM_DIPX03.txt
...
torchrun --nproc_per_node=1 --master_addr localhost --master_port 14056 main_dipx.py --model memvit_dipx --num_classes 7 --mem_per_layer 6 --batch 1 
