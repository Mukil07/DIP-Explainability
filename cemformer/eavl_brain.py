...
from utils.Customdataloader_brain_eval import CustomDataset
...
if __name__ == '__main__':
    ...
    checkpoint = "/scratch/mukil/cemformer/best_model_dir/best_model2.pth"
    #import pdb;pdb.set_trace()
    new_length = 393 
    num_channels = 768  
    ...
    with torch.no_grad():
        ...
        for i, (img1,img2,cls,context) in tqdm(enumerate(validation_loader)): 
