...
from utils.Custom_dataloader_new import CustomDataset
...
def cross_validate_model(args, dataset, n_splits=5):
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dataset)):
        ...
        log_dir = f"runs3/fold_brain_{fold}"  # Separate log directory for each fold
...
def train(args, train_dataloader, valid_dataloader,model,criterion, optimizer, device,writer):
    ...
    # cleanup() 
        ...
        writer.add_figure('Confusion Matrix (Brain)', fig)
