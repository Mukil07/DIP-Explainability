...
#SBATCH --output=output_DIPX/ego_nogaze.txt
...
python tools/run_net_final.py \
  ...
  CBM.GAZE_CBM False CBM.EGO_CBM True CBM.COMB_BOTTLE False TRAIN.AUTO_RESUME False SOLVER.MAX_EPOCH 200 MVIT.LATE_AVG True OUTPUT_DIR ./egonogaze
