        ...
        *images,cls,gaze,ego = batch
        ...
        with torch.cuda.amp.autocast(enabled=cfg.TRAIN.MIXED_PRECISION):
            ...
            if cfg.MODEL.MODEL_NAME == "ContrastiveModel" and partial_loss:
                ...
                loss = loss_fun(preds[0], labels) # for two ego prediciton preds is to be used for action class 
        ...
        if cfg.DETECTION.ENABLE:
            ...
            if cfg.DATA.MULTI_LABEL:
                ...
                # Compute the errors.
                num_topks_correct = metrics.topks_correct(preds[0], labels, (1, 5)) # changed to preds
                top1_err, top5_err = [
                    (1.0 - x / preds[0].size(0)) * 100.0 for x in num_topks_correct # changed to preds
                ]
                # Gather all the predictions across all the devices.
                if cfg.NUM_GPUS > 1:
        ...
        if cfg.DETECTION.ENABLE:
            ...
            if cfg.DATA.MULTI_LABEL:
                ...
                if cfg.DATA.IN22k_VAL_IN1K != "":
                    preds = preds[:, :1000]
                # Compute the errors.
                num_topks_correct = metrics.topks_correct(preds[0], labels, (1, 5)) # changed to preds, earlier preds[0]
