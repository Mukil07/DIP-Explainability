...
#SBATCH --output=nobottle_new2.txt
...
python tools/run_net_final.py \
  ...
  CBM.GAZE_CBM False CBM.EGO_CBM False CBM.COMB_BOTTLE False SOLVER.MAX_EPOCH 200 TRAIN.AUTO_RESUME True OUTPUT_DIR ./nobottle
