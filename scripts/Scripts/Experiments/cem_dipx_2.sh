...
#SBATCH --output=output_DIPX/ego_cem2.txt
...
python cem/main_dipx_cem.py --model $MODEL --batch 1 --num_classes 7 --dataset $DATASET      --technique $TECH  --dropout 0.55 --accumulation 4 \
